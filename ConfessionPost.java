...
public class ConfessionPost {
     ...
     */
    public void setPost(String content, String postID, Date postTime) {
        this.content = content;
        this.postID = postID;
    ...
    /**
     * Creates a unique Confession Post ID. This method generate an ID by
     * checking the data class. If a post ID already taken, it will increase
     * counter by 1 until it found an available post ID.
     *
