...
public class Data {
    ...
    /**
     * Inserts new Confession Post to the data. This method add a child to the
     * designated node.
     *
    ...
    /**
     * Search for Confession Post ID that matches the user input. This method
     * will search for Confession Post that matches the post ID entered by the
     * user.
     *
    ...
    /**
     * Returns this tree data structure. This method is just a sample data.
     *
